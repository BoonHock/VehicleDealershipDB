-- =============================================
-- Author:		hock
-- Create date: 26.9.2019
-- Description:	select vehicle_expenses
-- =============================================
...
FROM [fin].[vehicle_expenses] VEHEXPENSES

JOIN [fin].[payment] PAYMENT
	ON PAYMENT.[payment] = VEHEXPENSES.[payment]
...
WHERE @vehicle = -1 
	OR VEHEXPENSES.[vehicle] = @vehicle
