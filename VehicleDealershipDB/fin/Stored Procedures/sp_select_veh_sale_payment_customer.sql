...
-- Description:	select vehicle payment received from customer
-- =============================================
CREATE PROCEDURE [fin].[sp_select_veh_sale_payment_customer] 
...
FROM [fin].[veh_sale_payment_customer] VPAY
