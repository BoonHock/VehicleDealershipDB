CREATE TABLE [fin].[vehicle_share] (
    ...
    [amount_percentage]  FLOAT (53)      CONSTRAINT [DF_vehicle_share_amount_percentage] DEFAULT ((0)) NOT NULL,
    [amount_money]       DECIMAL (18, 4) CONSTRAINT [DF_vehicle_share_amount] DEFAULT ((0)) NOT NULL,
