...
CREATE VIEW [veh].[Vw_veh_model_group_brand]
AS
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'veh', @level1type = N'VIEW', @level1name = N'Vw_veh_model_group_brand';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'veh', @level1type = N'VIEW', @level1name = N'Vw_veh_model_group_brand';
